...
namespace GameBoard
{
    public class Board
    {
        ...
        private Piece blank = new Blank("e", "");
        ...
        public void checkBoardPos(Piece currPiece)
        {
            ...
            if (!this.GameBoard[currPiece.currPos[0], currPiece.currPos[1]].Equals(currPiece))
            {
                for (int x = 0; x < this.GameBoard.GetLength(0); x++)
                {
                    for (int y = 0; y < this.GameBoard.GetLength(1); y++)
                    {
                        if (this.GameBoard[x, y].Equals(currPiece))
                        {
        ...
        {
            this.GameBoard[currPosition[0], currPosition[1]] = blank;
